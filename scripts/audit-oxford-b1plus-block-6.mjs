...
const context = read('data/vocabulary-rebuild/block-6-line-vocabulary.json');
const threshold = read('data/vocabulary-rebuild/block-6-b1plus-coverage.json');
const reviewPath = 'data/vocabulary-rebuild/block-6-oxford-review.json';
const reportPath = 'data/vocabulary-rebuild/block-6-oxford-audit.json';
...
const report={source:OXFORD_URL,parsedOxfordWords:oxford.size,blockId:'block-6',speeches:speeches.length,selectedKeys:selected.size,rawMissingCount:rawMissing.length,reviewedExclusionCount:Object.keys(excluded).length,unresolvedCount:unresolved.length,includeLexemeCoverageErrorCount:coverageErrors.length,unresolved,includeLexemeCoverageErrors:coverageErrors,rawMissing};
