...
const supplement = read('data/vocabulary-rebuild/block-6-neutral-supplement.json').entries || {};
const dictPath = 'data/vocabulary-rebuild/block-6-dictionary.json';
const fallbackPath = 'data/vocabulary-rebuild/block-6-neutral-fallbacks.json';
