'use strict';
const BUILD_ID='index-zero-2026-09-05-r37';
const SHELL_CACHE=`mts-zero-shell-${BUILD_ID}`;
const DATA_CACHE=`mts-zero-data-${BUILD_ID}`;
const SHELL=[
  './','./index.html','./src/app.css','./src/pdf-pages.css','./src/focus-mode.css','./src/stage-directions.css','./src/config.js','./src/data-store.js','./src/state-store.js','./src/resume-bookmarks.js','./src/speech-controller.js','./src/gesture-controls.js','./src/line-page-runtime.js','./src/line-independent-scroll.js','./src/line-transition-engine.js','./src/line-navigation-v2.js','./src/main.js','./src/pdf-pages.js','./src/stage-directions.js','./src/study/study.css','./src/study/structure-model.js','./src/study/structure-view.js','./src/study/dictionary-sheet.js',
